...
// in simulator we redefine to format for WTCoB Developer console
...
{\
	NSString * exceptionName = [@"org.wtcob." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wtcob";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWTCoBNativeItemNone = -1, 
	UIWTCoBNativeItemSpinner = -2,
	UIWTCoBNativeItemProgressBar = -3,
	
	UIWTCoBNativeItemSlider = -4,
	UIWTCoBNativeItemSwitch = -5,
	UIWTCoBNativeItemMultiButton = -6,
	UIWTCoBNativeItemSegmented = -7,
	
	UIWTCoBNativeItemTextView = -8,
	UIWTCoBNativeItemTextField = -9,
	UIWTCoBNativeItemSearchBar = -10,
	
	UIWTCoBNativeItemPicker = -11,
	UIWTCoBNativeItemDatePicker = -12,
	
	UIWTCoBNativeItemInfoLight = -13,
	UIWTCoBNativeItemInfoDark = -14,
	
	UIWTCoBNativeItemDisclosure = -15,
	
	UIWTCoBNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all WTCoB instances of
