//Referencing the authors code here, which is Aaron Saunders and not adding the photo part from chapter 11. --Lauren
//In this file we are adding the android push library and the acs library. The ACS lib is used to allow the push notification API calls and the Android lib is for receiving notifications.
