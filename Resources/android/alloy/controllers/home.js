...
function Controller() {
    function __alloyId21() {
        $.__views.home.removeEventListener("open", __alloyId21);
    ...
    function __alloyId25() {
        $.__views.home.removeEventListener("open", __alloyId25);
    ...
    $.__views.home.addEventListener("open", __alloyId21);
    $.__views.home.addEventListener("open", __alloyId25);
